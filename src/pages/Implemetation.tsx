      ...
      {[...publications].reverse().map((publication) => (
          <div key={publication.id} className="space-y-3 pt-10 ">
            ...
            <div className="card pub shadow-xl ">
              ...
              <Link to={'/post'}> <p className="justify-end bcolor flex text-3xl"><BsThreeDotsVertical /> </p> </Link>
            ...
            <p className="justify-end flex">{publication.publication_date}/{publication.id}</p>
