...
function App() {
  ...
  <figure><img src={aroundthefur} alt="Album" style={{width:400, height:350}}/></figure>
  ...
  <h1 className="card-title text-5xl pb-10">Around the Fur</h1>
    ...
    <p className='justify-left flex text-1xl'>Clique no botão para ser redirecionado.</p>
    <div className="card-actions justify-end">
    <button className="" onClick={()=>document.getElementById('my_modal_1').showModal()}>Escutar</button>
<dialog id="my_modal_1" className="modal">
  <div className="modal-box w-11/12 max-w-5xl bg-black">
    ...
    <div className="modal-action">
      ...
      <div className="card lg:card-side bg-black shadow-xl">
  <figure><img src={whitepony} alt="Album" style={{width:450, height:350}}/></figure>
  <div className="card-body">
  <h1 className="card-title text-5xl pb-10">White Pony</h1>
    ...
    <p className='justify-left flex text-1xl'>Clique no botão para ser redirecionado.</p>
    <div className="card-actions justify-end">
    <button className="" onClick={()=>document.getElementById('my_modal_2').showModal()}>Escutar</button>
